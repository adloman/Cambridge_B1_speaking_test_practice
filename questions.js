const questionBank = [
    ...
    { 
        ...
        options: [
            { text: "I really enjoy going to the cinema because I love movies. What about you?", score: 100, feedback: "Great use of 'really enjoy' and interaction." },
    ...
    { 
        ...
        options: [
            { text: "I prefer outside because the fresh air makes me feel energetic. Which do you prefer?", score: 100, feedback: "Perfect comparison and follow-up." },
    ...
    { 
        ...
        options: [
            { text: "I love autumn because the weather is cool and the colors are beautiful. What's your favorite?", score: 100, feedback: "Nice adjectives and follow-up." },
    ...
    { 
        ...
        options: [
            { text: "I'd prefer the city because there's so much to do at night. Would you find a village boring?", score: 100, feedback: "Engaging and descriptive." },
    ...
    { 
        ...
        options: [
            { text: "It's very important! I listen to pop music while I study to help me focus. What do you listen to?", score: 100, feedback: "Explains 'why' and asks 'what'." },
    ...
    { 
        ...
        options: [
            { text: "I think playing a team sport is best because it's fun and social. Do you play any sports?", score: 100, feedback: "Excellent B1 reasoning." },
    ...
    { 
        ...
        options: [
            { text: "I prefer a relaxing holiday on the beach because I work hard all year. What about you?", score: 100, feedback: "Explains 'why' very well." },
    ...
    { 
        ...
        options: [
            { text: "I love History because learning about the past is fascinating. What's your favorite?", score: 100, feedback: "Uses a strong adjective ('fascinating')." },
    ...
    { 
        ...
        options: [
            { text: "It's useful for staying in touch, but it can be a waste of time. How much time do you spend on it?", score: 100, feedback: "Balanced view with interaction." },
    ...
    { 
        ...
        options: [
            { text: "I have mixed feelings. I like seeing the animals, but I don't like seeing them in cages. What do you think?", score: 100, feedback: "Sophisticated 'mixed feelings' response." },
    ...
    { 
        ...
        options: [
            { text: "Yes, because you might need it for an emergency or something special. Are you good at saving?", score: 100, feedback: "Uses 'might' and 'emergency'." },
    ...
    { 
        ...
        options: [
            { text: "Not really, I find it quite tiring. I prefer shopping online. What about you?", score: 100, feedback: "Uses 'quite' and 'online' contrast." },
    ...
    { 
        ...
        options: [
            { text: "I prefer playing them because it keeps me healthy and I enjoy the competition. What do you think?", score: 100, feedback: "Great use of 'keeps me healthy'." },
    ...
    { 
        ...
        options: [
            { text: "Yes, it gives you energy for the morning. I usually have eggs. What do you have?", score: 100, feedback: "Good follow-up question." },
    ...
    { 
        ...
        options: [
            { text: "I think having siblings is better because you're never lonely. Do you have any?", score: 100, feedback: "Perfect use of 'never lonely'." },
    ...
    { 
        ...
        options: [
            { text: "Yes, I find it relaxing and I love trying new recipes. Can you cook?", score: 100, feedback: "Interactive and uses 'trying new recipes'." },
    ...
    { 
        ...
        options: [
            { text: "I usually stay inside and watch a movie or read. Do you like rainy days?", score: 100, feedback: "Good use of 'usually' and interaction." },
    ...
    { 
        ...
        options: [
            { text: "Yes, it helps you earn money and learn responsibility. Do you have a job?", score: 100, feedback: "Uses 'responsibility'—great B1 word." },
    ...
    { 
        ...
        options: [
            { text: "In my opinion, the mountains are the most beautiful, especially in winter. Have you been there?", score: 100, feedback: "Superlative 'most beautiful' and interaction." },
    ...
    { 
        ...
        options: [
            { text: "I prefer the morning because my brain is fresh and I can focus better. When do you study?", score: 100, feedback: "Metaphorical 'brain is fresh'—very B1!" },
    ...
    { 
        ...
        options: [
            { text: "The cinema is better because the screen is huge, but home is more comfortable. What do you think?", score: 100, feedback: "Good contrast using 'but'." },
    ...
    { 
        ...
        options: [
            { text: "I think the internet is the most important because it connects the whole world. Don't you agree?", score: 100, feedback: "Strong argument and check for agreement." },
    ...
    { 
        ...
        options: [
            { text: "Online is better because it's updated every minute. Do you follow the news?", score: 100, feedback: "Uses Passive voice ('updated') correctly." },
    ...
    { 
        ...
        options: [
            { text: "Yes, it’s an essential skill for when they live alone. Can you cook a full meal?", score: 100, feedback: "Uses 'essential skill' and 'when they live alone'." },
    ...
    { 
        ...
        options: [
            { text: "I like to bake something delicious or watch a series. Do you like baking?", score: 100, feedback: "Interactive and creative." },
    ...
    { 
        ...
        options: [
            { text: "Yes, it shows that you respect other people's time. Are you usually on time?", score: 100, feedback: "Uses 'respect' and asks a question." },
    ...
    { 
        ...
        options: [
            { text: "I love it, but only if it's not too crowded. Do you like swimming in the sea?", score: 100, feedback: "Condition 'only if' used well." },
    ...
    { 
        ...
        options: [
            { text: "A little is good for practice, but too much is stressful. Do you get much homework?", score: 100, feedback: "Balanced view: 'practice' vs 'stressful'." },
    ...
    { 
        ...
        options: [
            { text: "I love Christmas because the whole family gets together. What's your favorite?", score: 100, feedback: "Phrasal verb: 'gets together'." },
    ...
    { 
        ...
        options: [
            { text: "I prefer a small group because the conversation is more interesting. What about you?", score: 100, feedback: "Good reasoning and follow-up." },
    ...
    { 
        ...
        options: [
            { text: "Yes, it’s a vital safety skill and it's also great exercise. Can you swim?", score: 100, feedback: "Uses 'vital' and 'safety skill'." },
    ...
    { 
        ...
        options: [
            { text: "Yes, public transport is better for the environment. Do you use the bus?", score: 100, feedback: "Uses 'environment' and interaction." },
    ...
    { 
        ...
        options: [
            { text: "I'm not a fan of horror movies because they are too scary for me. Do you like them?", score: 100, feedback: "Uses 'not a fan' and interaction." },
    ...
    { 
        ...
        options: [
            { text: "Definitely, because you can enjoy the fresh air and grow flowers. Do you have a garden?", score: 100, feedback: "Uses 'fresh air' and interaction." },
    ...
    { 
        ...
        options: [
            { text: "Yes, I love seeing live performances; it feels more real than a movie. Have you been?", score: 100, feedback: "Uses 'live performances'—great B1 vocab." },
    ...
    { 
        ...
        options: [
            { text: "Yes, it gives you more freedom to travel whenever you want. Can you drive yet?", score: 100, feedback: "Uses 'freedom' and 'whenever'." },
    ...
    { 
        ...
        options: [
            { text: "I prefer tea because it's more relaxing and there are so many flavors. Which do you prefer?", score: 100, feedback: "Good contrast and interaction." },
    ...
    { 
        ...
        options: [
            { text: "It's good for independence, but traveling with friends is safer and more fun. What do you think?", score: 100, feedback: "Uses 'independence' and interaction." },
